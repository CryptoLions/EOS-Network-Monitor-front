          ...
          {!modalDataFetchingState &&
            !!Object.keys(accountInfo).length && (
              <InfoContainer>
                ...
                <DataBlock>
                  <TextSpanBold>{t('i18nModal.i18nAccountInfo.tokens')}:</TextSpanBold>
                  <TextSpan>
                    {!accountInfo.balances || !accountInfo.balances.length
                      ? '--'
                      : accountInfo.balances.map(item => <span>{item} </span>)}
                  </TextSpan>
                </DataBlock>
                <DataBlock>
                  <div>
                ...
                {!!accountInfo.voter_info && (
                  <DataBlock>
                    ...
                    <div>
                      ...
                      {(accountInfo.voter_info.producers && accountInfo.voter_info.producers.length) || '--'}
                    </div>
                    <div>
