    ...
    i18nModal: {
      ...
      i18nLegend: {
        ...
        content: [
          ...
          'Отображаются все зарегистрированные продюсеры и извлекает инфо о конечных точках из lynx.json file',
        ],
        ...
        bps: `БП отмечены серым если неверный или отсутствует lynx.json файл. Мы делаем периодическую проверку. Также, мы проверяем только топ 60.`,
        moreinfo: 'Подробнее',
